...
INSERT INTO api_keys (service_name, display_name, description, keys, environment) VALUES
  ('resend', 'RESEND', 'Service d''envoi d''emails transactionnels', '{"api_key": ""}', 'production'),
  ('brevo', 'BREVO', 'Service d''envoi de SMS', '{"api_key": ""}', 'production'),
  ('orange_money', 'Orange Money', 'Paiement mobile Orange Money', '{"merchant_id": "", "api_key": ""}', 'sandbox'),
  ('mtn_money', 'MTN Money', 'Paiement mobile MTN', '{"subscription_key": "", "api_user": "", "api_key": ""}', 'sandbox'),
  ('moov_money', 'Moov Money', 'Paiement mobile Moov', '{"merchant_id": "", "api_key": ""}', 'sandbox'),
  ('wave', 'Wave', 'Paiement mobile Wave', '{"merchant_id": "", "api_key": ""}', 'sandbox'),
  ('cryptoneo', 'CryptoNeo', 'Signature électronique PSE', '{"base_url": "", "client_id": "", "client_secret": "", "webhook_secret": ""}', 'sandbox'),
  ('mapbox', 'Mapbox', 'Service de cartographie', '{"access_token": ""}', 'production'),
  ('firebase', 'Firebase', 'Notifications push', '{"server_key": "", "vapid_key": ""}', 'production'),
  ('sentry', 'Sentry', 'Monitoring et tracking d''erreurs', '{"dsn": ""}', 'production'),
  ('oneci', 'ONECI', 'Vérification CNI ivoirienne', '{"api_key": "", "api_url": ""}', 'production'),
  ('cnam', 'CNAM', 'Vérification CNAM', '{"api_key": "", "api_url": ""}', 'production'),
  ('smile_id', 'Smile ID', 'Vérification faciale KYC', '{"partner_id": "", "api_key": "", "callback_url": ""}', 'production')
